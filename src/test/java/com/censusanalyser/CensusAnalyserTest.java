...
public class CensusAnalyserTest {
    ...
    private static final String INDIA_CENSUS_CSV_FILE_PATH_WITH_COMMON_FIELD = "./src/test/resources/IndiaStateCensusDataCombination.csv";
    ...
    public void givenIndiaCensusDataAndIndiaStateCodeData_WhenSortedOnState_ShouldReturnSortedResult() {
        try {
            ...
            String sortedCensusData = censusAnalyser.getSortData(CensusAnalyser.CountryFields.STATE);
    ...
    public void givenIndiaCensusDataAndIndiaStateCodeData_WhenSortedByPopulation_ShouldReturnSortedResult() {
        try {
            CensusAnalyser censusAnalyser = new CensusAnalyser();
            censusAnalyser.loadCensusData(CensusAnalyser.Country.INDIA, INDIA_CENSUS_CSV_FILE_PATH, INDIA_STATE_CODE_CSV_FILE_PATH);
            String sortedCensusData = censusAnalyser.getSortData(CensusAnalyser.CountryFields.POPULATION);
            IndiaCensusCSV[] censusCSV = new Gson().fromJson(sortedCensusData, IndiaCensusCSV[].class);
    ...
    public void givenIndiaCensusDataAndIndiaStateCodeData_WhenSortedByArea_ShouldReturnSortedResult() {
        try {
            CensusAnalyser censusAnalyser = new CensusAnalyser();
            censusAnalyser.loadCensusData(CensusAnalyser.Country.INDIA, INDIA_CENSUS_CSV_FILE_PATH, INDIA_STATE_CODE_CSV_FILE_PATH);
            String sortedCensusData = censusAnalyser.getSortData(CensusAnalyser.CountryFields.TOTAL_AREA);
            IndiaCensusCSV[] censusCSV = new Gson().fromJson(sortedCensusData, IndiaCensusCSV[].class);
    ...
    public void givenIndiaCensusDataAndIndiaStateCodeData_WhenSortedByDensity_ShouldReturnSortedResult() {
        try {
            CensusAnalyser censusAnalyser = new CensusAnalyser();
            censusAnalyser.loadCensusData(CensusAnalyser.Country.INDIA, INDIA_CENSUS_CSV_FILE_PATH, INDIA_STATE_CODE_CSV_FILE_PATH);
            String sortedCensusData = censusAnalyser.getSortData(CensusAnalyser.CountryFields.POPULATION_DENSITY);
            IndiaCensusCSV[] censusCSV = new Gson().fromJson(sortedCensusData, IndiaCensusCSV[].class);
    ...
    public void callSortFunction_withoutLoadingFile_ShouldThrowingException() {
        try {
            CensusAnalyser censusAnalyser = new CensusAnalyser();
            censusAnalyser.getSortData(CensusAnalyser.CountryFields.STATE);
        } catch (CensusAnalyserException e) {
    ...
    @Test
    public void givenIndiaCensusDataAndIndiaStateCodeData_WhenSortedByPopulationAndDensity_ShouldReturnSortedResult() {
        try {
            CensusAnalyser censusAnalyser = new CensusAnalyser();
            censusAnalyser.loadCensusData(CensusAnalyser.Country.INDIA, INDIA_CENSUS_CSV_FILE_PATH_WITH_COMMON_FIELD, INDIA_STATE_CODE_CSV_FILE_PATH);
            String sortedCensusData = censusAnalyser.getSortData(CensusAnalyser.CountryFields.POPULATION_THEN_DENSITY);
            IndiaCensusCSV[] censusCSV = new Gson().fromJson(sortedCensusData, IndiaCensusCSV[].class);
            Assert.assertEquals("Chattisgarh", censusCSV[0].state);
        } catch (CensusAnalyserException e) {
        }
    }

    @Test
    public void givenUSCensusData_WhenSortedByPopulationAndDensity_ShouldReturnSortedResult() {
        try {
            CensusAnalyser censusAnalyser = new CensusAnalyser();
            censusAnalyser.loadCensusData(CensusAnalyser.Country.US,US_CENSUS_FILE_PATH );
            String sortedCensusData = censusAnalyser.getSortData(CensusAnalyser.CountryFields.POPULATION_THEN_DENSITY);
