...
public class CensusAnalyserTest {
    ...
    public void givenIndiaStateCodeData_ShouldReturnExactCount() {
        try {
            ...
            int numOfStateCodeRecord = censusAnalyser.loadCensusData(CensusAnalyser.Country.India,INDIA_STATE_CODE_CSV_FILE_PATH,INDIA_CENSUS_CSV_FILE_PATH);
            System.out.println("Count"+numOfStateCodeRecord);
            Assert.assertEquals(29, numOfStateCodeRecord);
    ...
    public void givenIndiaStateCodeData_WithEmptyFile_ShouldThrowException() {
        try {
            ...
            ExpectedException exceptionRule = ExpectedException.none();
            exceptionRule.expect(CensusAnalyserException.class);
            censusAnalyser.loadCensusData(CensusAnalyser.Country.India,null);
        } catch (CensusAnalyserException e) {
